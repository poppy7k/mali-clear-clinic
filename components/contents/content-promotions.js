            ...
            <div id="content" class="flex justify-center my-2 text-gray-700">
                ...
                <div class="mx-20 grid-row my-auto">
                    ...
                    <div class="justify-self-center mt-4">
                        <button href="#" class="font-semibold py-2 px-4 border-2 rounded-[22px] transition-all duration-300 hover:bg-yellow-400 hover:text-black hover:fill-black pointer-events-auto">
...
customElements.define("content-promotion", Promotion);